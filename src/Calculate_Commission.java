...
public class Calculate_Commission {
    ...
    void calcCommision ()
    {
        ...
        if (sales_amount >= 50000.00)
        {
            ...
            System.out.println("The commission amount for Rs." + sales_amount + " is Rs. " + sales_amount * 0.35);
        }
        else if (sales_amount>=30000.00)
        {
            ...
            System.out.println("The commission amount for Rs." + sales_amount + " is Rs. " + sales_amount * 0.20);
        }
        else if(sales_amount>=20000.00)
        {
            ...
            System.out.println("The commission amount for Rs." + sales_amount + " is Rs. " + sales_amount * 0.10);
        }
        else if (sales_amount>=10000.00)
        {
            ...
            System.out.println("The commission amount for Rs." + sales_amount + " is Rs. " + sales_amount * 0.5);
        }
        else
        {
            System.out.println("The commission rate is 2%");
            //returns the commission amount for commission rate of 2% on sales amount
            System.out.println("The commission amount for Rs." + sales_amount + " is Rs. " + sales_amount * 0.2);
        }
    }
//main method
